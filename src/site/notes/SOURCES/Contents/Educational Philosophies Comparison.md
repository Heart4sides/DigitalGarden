...
> "Learning is rooted in the questions of learners that arise through experiencing the world ([[-Si⛰️\|-Si⛰️]]). It is active ([[CARDS/Depth Psychology Theory/Initiating👋\|extraverted]]), not passive. The learner is a problem solver and thinker ([[CARDS/Typing Toolbox/-Ti🗡️\|-Ti🗡️]]) who makes meaning through his or her individual experience in the physical ([[-Si⛰️\|-Si⛰️]]) and cultural ([[CARDS/Typing Toolbox/-Fi🧭\|-Fi🧭]]) context"
